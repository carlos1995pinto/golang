...
type htmlstyleInside struct{
	beginScript,endScript int
	cssobjectPTR *CssObject
}
var chan2script []chan htmlscript = make([]chan htmlscript,0,2)
var chan2scriptStyleRep []chan int8 = make([]chan int8,0,4)
var chan2style []chan htmlstyle = make([]chan htmlstyle,0,2)
